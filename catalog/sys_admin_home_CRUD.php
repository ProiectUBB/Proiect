...
<div class="CrReUpDe">
  <button class="CRUD"><a href="sys_admin_home_admin_CRUD.php">C.R.U.D. ADMIN</a></button>
<button class="CRUD"><a href="sys_admin_home_profesor_CRUD.php">C.R.U.D. TEACHER</a></button>
<button class="CRUD"><a href="sys_admin_home_student_CRUD.php">C.R.U.D. STUDENT</a></button>
</div>
</div>
