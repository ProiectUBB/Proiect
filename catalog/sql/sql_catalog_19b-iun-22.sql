...
(1, 1, 'sysadmin', md5('sysadmin'), 'sysadmin', 'sysadmin', 'sysadmin@email.com', '0000-00-00 00:00:00'),
(2, 2, 'admin', md5('admin'), 'admin', 'admin', 'admin@email.com', '0000-00-00 00:00:00'),
(3, 3, 'teacher', md5('teacher'), 'teacher', 'teacher', 'teacher@email.com', '0000-00-00 00:00:00'),
(4, 4, 'student', md5('student'), 'student', 'student', 'student@email.com', '0000-00-00 00:00:00'),
(6, 3, 'osco47', md5('osco47'), 'Oscar', 'Cox', 'oscar.cox@email.com', '2022-06-19 11:31:07'),
(7, 3, 'frja64', md5('frja64'), 'Frederick', 'Jackson', 'frederick.jackson@email.com', '2022-06-19 11:31:07'),
(8, 3, 'reda65', md5('reda65'), 'Reece', 'Dawson', 'reece.dawson@email.com', '2022-06-19 11:31:07'),
(9, 3, 'hama67', md5('hama67'), 'Harry', 'Matthews', 'harry.matthews@email.com', '2022-06-19 11:31:07'),
(10, 4, 'maca14', md5('maca14'), 'Mason', 'Carpenter', 'mason.carpenter@email.com', '2022-06-19 11:31:07'),
(11, 4, 'dach80', md5('dach80'), 'Dario', 'Chambers', 'dario.chambers@email.com', '2022-06-19 11:31:07'),
(12, 4, 'dala86', md5('dala86'), 'Darren', 'Lancaster', 'darren.lancaster@email.com', '2022-06-19 11:31:07'),
(13, 4, 'loca23', md5('loca23'), 'London', 'Cantu', 'london.cantu@email.com', '2022-06-19 11:31:07'),
(14, 4, 'juch33', md5('juch33'), 'Julien', 'Church', 'julien.church@email.com', '2022-06-19 11:31:07'),
(15, 4, 'visu71', md5('visu71'), 'Victoria', 'Sutton', 'victoria.sutton@email.com', '2022-06-19 11:31:07'),
(16, 4, 'lael20', md5('lael20'), 'Lara', 'Ellis', 'lara.ellis@email.com', '2022-06-19 11:31:07'),
(17, 4, 'lewe17', md5('lewe17'), 'Lexi', 'Wells', 'lexi.wells@email.com', '2022-06-19 11:31:07'),
(18, 4, 'escl20', md5('escl20'), 'Esme', 'Clark', 'esme.clark@email.com', '2022-06-19 11:31:07'),
(19, 4, 'naal62', md5('naal62'), 'Naomi', 'Allen', 'naomi.allen@email.com', '2022-06-19 11:31:07'),
(20, 4, 'emhe79', md5('emhe79'), 'Emery', 'Hendricks', 'emery.hendricks@email.com', '2022-06-19 11:31:07'),
(21, 4, 'cemy69', md5('cemy69'), 'Cecelia', 'Myers', 'cecelia.myers@email.com', '2022-06-19 11:31:07'),
(22, 4, 'ishi16', md5('ishi16'), 'Isabel', 'Higgins', 'isabel.higgins@email.com', '2022-06-19 11:31:07'),
(23, 4, 'meca79', md5('meca79'), 'Meadow', 'Carlson', 'meadow.carlson@email.com', '2022-06-19 11:31:07'),
(24, 4, 'ripa79', md5('ripa79'), 'River', 'Parry', 'river.parry@email.com', '2022-06-19 11:31:07'),
(25, 4, 'lefr42', md5('lefr42'), 'Lesley', 'Fraser', 'lesley.fraser@email.com', '2022-06-19 11:31:07'),
(26, 4, 'stbu18', md5('stbu18'), 'Steff', 'Burton', 'steff.burton@email.com', '2022-06-19 11:31:07'),
(27, 4, 'saho26', md5('saho26'), 'Sammy', 'Hopkins', 'sammy.hopkins@email.com', '2022-06-19 11:31:07'),
(28, 4, 'aulo27', md5('aulo27'), 'Aubrey', 'Lowe', 'aubrey.lowe@email.com', '2022-06-19 11:31:07'),
(29, 4, 'skhi30', md5('skhi30'), 'Skyler', 'Hill', 'skyler.hill@email.com', '2022-06-19 11:31:07'),
(30, 4, 'caes57', md5('caes57'), 'Caden', 'Espinoza', 'caden.espinoza@email.com', '2022-06-19 11:31:07'),
(31, 4, 'roro57', md5('roro57'), 'Robin', 'Roberts', 'robin.roberts@email.com', '2022-06-19 11:31:07'),
(32, 4, 'bepa51', md5('bepa51'), 'Bennie', 'Pate', 'bennie.pate@email.com', '2022-06-19 11:31:07'),
(33, 4, 'hape99', md5('hape99'), 'Harper', 'Peck', 'harper.peck@email.com', '2022-06-19 11:31:07'),
(34, 4, 'iscu75', md5('iscu75'), 'Isabelle', 'Cunningham', 'isabelle.cunningham@email.com', '2022-06-19 11:31:07'),
(35, 4, 'kepr96', md5('kepr96'), 'Keira', 'Price', 'keira.price@email.com', '2022-06-19 11:31:07'),
(36, 4, 'maat66', md5('maat66'), 'Maria', 'Atkinson', 'maria.atkinson@email.com', '2022-06-19 11:31:07'),
(37, 4, 'jakh41', md5('jakh41'), 'Jasmine', 'Khan', 'jasmine.khan@email.com', '2022-06-19 11:31:07'),
(38, 4, 'pabu73', md5('pabu73'), 'Paige', 'Burke', 'paige.burke@email.com', '2022-06-19 11:31:07'),
(39, 4, 'kasa79', md5('kasa79'), 'Karen', 'Sanchez', 'karen.sanchez@email.com', '2022-06-19 11:31:07'),
(40, 4, 'laho67', md5('laho67'), 'Laurel', 'Howard', 'laurel.howard@email.com', '2022-06-19 11:31:07'),
(41, 4, 'list77', md5('list77'), 'Lillyana', 'Stanton', 'lillyana.stanton@email.com', '2022-06-19 11:31:07'),
(42, 4, 'chri93', md5('chri93'), 'Cherish', 'Richardson', 'cherish.richardson@email.com', '2022-06-19 11:31:07'),
(43, 4, 'elle82', md5('elle82'), 'Elaine', 'Levine', 'elaine.levine@email.com', '2022-06-19 11:31:07'),
(44, 4, 'jopr46', md5('jopr46'), 'Josh', 'Price', 'josh.price@email.com', '2022-06-19 11:31:07'),
(45, 4, 'hath50', md5('hath50'), 'Harrison', 'Thomas', 'harrison.thomas@email.com', '2022-06-19 11:31:07'),
(46, 4, 'mapr46', md5('mapr46'), 'Mason', 'Price', 'mason.price@email.com', '2022-06-19 11:31:07'),
(47, 4, 'sapo64', md5('sapo64'), 'Sam', 'Powell', 'sam.powell@email.com', '2022-06-19 11:31:07'),
(48, 4, 'elbu38', md5('elbu38'), 'Ellis', 'Burke', 'ellis.burke@email.com', '2022-06-19 11:31:07'),
(49, 4, 'albl11', md5('albl11'), 'Alonzo', 'Blanchard', 'alonzo.blanchard@email.com', '2022-06-19 11:31:07'),
(50, 4, 'cawe91', md5('cawe91'), 'Cayden', 'Weeks', 'cayden.weeks@email.com', '2022-06-19 11:31:07'),
(51, 4, 'jaev73', md5('jaev73'), 'Jaden', 'Everett', 'jaden.everett@email.com', '2022-06-19 11:31:07'),
(52, 4, 'nopa91', md5('nopa91'), 'Noah', 'Padilla', 'noah.padilla@email.com', '2022-06-19 11:31:07'),
(53, 4, 'nash42', md5('nash42'), 'Nathan', 'Sheppard', 'nathan.sheppard@email.com', '2022-06-19 11:31:07'),
(54, 4, 'phan45', md5('phan45'), 'Phoebe', 'Andrews', 'phoebe.andrews@email.com', '2022-06-19 11:31:07'),
(55, 4, 'elsm68', md5('elsm68'), 'Elsie', 'Smith', 'elsie.smith@email.com', '2022-06-19 11:31:07'),
(56, 4, 'mejo53', md5('mejo53'), 'Melissa', 'Jordan', 'melissa.jordan@email.com', '2022-06-19 11:31:07'),
(57, 4, 'emwa20', md5('emwa20'), 'Emilia', 'Wallace', 'emilia.wallace@email.com', '2022-06-19 11:31:07'),
(58, 4, 'macu71', md5('macu71'), 'Maisy', 'Cunningham', 'maisy.cunningham@email.com', '2022-06-19 11:31:07'),
(59, 4, 'adal93', md5('adal93'), 'Addyson', 'Alford', 'addyson.alford@email.com', '2022-06-19 11:31:07'),
(60, 4, 'alem65', md5('alem65'), 'Alexia', 'Emerson', 'alexia.emerson@email.com', '2022-06-19 11:31:07'),
(61, 4, 'olca56', md5('olca56'), 'Olivia', 'Castillo', 'olivia.castillo@email.com', '2022-06-19 11:31:07'),
(62, 4, 'skph73', md5('skph73'), 'Skyla', 'Phelps', 'skyla.phelps@email.com', '2022-06-19 11:31:07'),
(63, 4, 'anmu44', md5('anmu44'), 'Anika', 'Mueller', 'anika.mueller@email.com', '2022-06-19 11:31:07'),
(64, 4, 'lahe33', md5('lahe33'), 'Lane', 'Henderson', 'lane.henderson@email.com', '2022-06-19 11:31:07'),
(65, 4, 'tagr59', md5('tagr59'), 'Tanner', 'Gray', 'tanner.gray@email.com', '2022-06-19 11:31:07'),
(66, 4, 'chpo43', md5('chpo43'), 'Charlie', 'Porter', 'charlie.porter@email.com', '2022-06-19 11:31:07'),
(67, 4, 'brmc59', md5('brmc59'), 'Bret', 'Mcdonald', 'bret.mcdonald@email.com', '2022-06-19 11:31:07'),
(68, 4, 'camo29', md5('camo29'), 'Caden', 'Morris', 'caden.morris@email.com', '2022-06-19 11:31:07'),
(69, 4, 'stco68', md5('stco68'), 'Steff', 'Cox', 'steff.cox@email.com', '2022-06-19 11:31:07'),
(70, 4, 'mafr14', md5('mafr14'), 'Maddox', 'Franks', 'maddox.franks@email.com', '2022-06-19 11:31:07'),
(71, 4, 'lefi64', md5('lefi64'), 'Leigh', 'Fischer', 'leigh.fischer@email.com', '2022-06-19 11:31:07'),
(72, 4, 'joch15', md5('joch15'), 'Jordan', 'Cherry', 'jordan.cherry@email.com', '2022-06-19 11:31:07'),
(73, 4, 'chca81', md5('chca81'), 'Charlie', 'Campos', 'charlie.campos@email.com', '2022-06-19 11:31:07'),
(74, 4, 'avma63', md5('avma63'), 'Ava', 'Marshall', 'ava.marshall@email.com', '2022-06-19 11:31:07'),
(75, 4, 'fabr74', md5('fabr74'), 'Faith', 'Brooks', 'faith.brooks@email.com', '2022-06-19 11:31:07'),
(76, 4, 'catu56', md5('catu56'), 'Caitlin', 'Turner', 'caitlin.turner@email.com', '2022-06-19 11:31:07'),
(77, 4, 'ruho49', md5('ruho49'), 'Ruby', 'Howard', 'ruby.howard@email.com', '2022-06-19 11:31:07'),
(78, 4, 'kafo58', md5('kafo58'), 'Kayla', 'Fox', 'kayla.fox@email.com', '2022-06-19 11:31:07'),
(79, 4, 'adga95', md5('adga95'), 'Adeline', 'Garner', 'adeline.garner@email.com', '2022-06-19 11:31:07'),
(80, 4, 'lamu12', md5('lamu12'), 'Lainey', 'Mullen', 'lainey.mullen@email.com', '2022-06-19 11:31:07'),
(81, 4, 'chba98', md5('chba98'), 'Christina', 'Barrera', 'christina.barrera@email.com', '2022-06-19 11:31:07'),
(82, 4, 'xiro46', md5('xiro46'), 'Ximena', 'Roth', 'ximena.roth@email.com', '2022-06-19 11:31:07'),
(83, 4, 'sobo80', md5('sobo80'), 'Sofie', 'Bonner', 'sofie.bonner@email.com', '2022-06-19 11:31:07'),
(84, 4, 'adbo25', md5('adbo25'), 'Adam', 'Booth', 'adam.booth@email.com', '2022-06-19 11:31:07'),
(85, 4, 'kaha92', md5('kaha92'), 'Kayden', 'Hayes', 'kayden.hayes@email.com', '2022-06-19 11:31:07'),
(86, 4, 'lufr86', md5('lufr86'), 'Luca', 'Fraser', 'luca.fraser@email.com', '2022-06-19 11:31:07'),
(87, 4, 'alma33', md5('alma33'), 'Alfie', 'Martin', 'alfie.martin@email.com', '2022-06-19 11:31:07'),
(88, 4, 'isbr52', md5('isbr52'), 'Isaac', 'Brown', 'isaac.brown@email.com', '2022-06-19 11:31:07'),
(89, 4, 'vaju43', md5('vaju43'), 'Van', 'Juarez', 'van.juarez@email.com', '2022-06-19 11:31:07'),
(90, 4, 'brmu18', md5('brmu18'), 'Braylen', 'Murray', 'braylen.murray@email.com', '2022-06-19 11:31:07'),
(91, 4, 'gafi77', md5('gafi77'), 'Gauge', 'Fisher', 'gauge.fisher@email.com', '2022-06-19 11:31:07'),
(92, 4, 'cobl27', md5('cobl27'), 'Colby', 'Blanchard', 'colby.blanchard@email.com', '2022-06-19 11:31:07'),
(93, 4, 'cabr89', md5('cabr89'), 'Camilo', 'Brown', 'camilo.brown@email.com', '2022-06-19 11:31:07'),
(94, 4, 'rewi53', md5('rewi53'), 'Reggie', 'Wilson', 'reggie.wilson@email.com', '2022-06-19 11:31:07'),
(95, 4, 'cawa20', md5('cawa20'), 'Carol', 'Walsh', 'carol.walsh@email.com', '2022-06-19 11:31:07'),
(96, 4, 'vahu71', md5('vahu71'), 'Val', 'Hussain', 'val.hussain@email.com', '2022-06-19 11:31:07'),
(97, 4, 'raco12', md5('raco12'), 'Raylee', 'Cook', 'raylee.cook@email.com', '2022-06-19 11:31:07'),
(98, 4, 'brmo98', md5('brmo98'), 'Brook', 'Morgan', 'brook.morgan@email.com', '2022-06-19 11:31:07'),
(99, 4, 'java46', md5('java46'), 'Jamie', 'Valentine', 'jamie.valentine@email.com', '2022-06-19 11:31:07');
