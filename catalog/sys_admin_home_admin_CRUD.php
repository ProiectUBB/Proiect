...
<div class="CrReUpDe">
  <button class="CRUD"><a href="sys_admin_home_admin_CRUD_create.php">Create an admin</a></button>
<button class="CRUD">Read info about an admin</button>
<button class="CRUD">Print all admin</button>
<button class="CRUD">Update an admin</button>
<button class="CRUD">Delete an admin</button>
