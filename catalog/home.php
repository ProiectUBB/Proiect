...
<div class="container">
  <div class="row">
    <div class="col">
        ...
        <br>
        <?php if ($_SESSION['idRol'] == 1) { /* If user is logged in as SYSADMIN */ ?> 
        ...
        <?php } elseif ($_SESSION['idRol'] == 2) { /* If user is logged in as ADMIN */ ?> 
        ...
        <?php } elseif ($_SESSION['idRol'] == 3) { /* If user is logged in as STUDENT */ ?> 
        ...
        <?php } elseif ($_SESSION['idRol'] == 4) { /* If user is logged in as TEACHER */ ?> 
