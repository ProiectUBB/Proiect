...
<div class="CrReUpDe">
  <button class="CRUD"><a href="sys_admin_home_profesor_CRUD_create.php">Create a teacher</a></button>
<button class="CRUD">Read info about a teacher</button>
<button class="CRUD">Print all teachers</button>
<button class="CRUD">Update a teacher</button>
<button class="CRUD">Delete a teacher</button>
